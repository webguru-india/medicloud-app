...
export class DashboardComponent implements OnInit {
  ...
  constructor(private globalConfigs: GlobalConfigs, private cookieService: CookieService, public pageTitle: Title) {
    if(typeof this.appAccessToken === 'undefined' || this.appAccessToken == '') {
      window.location.href = this.globalConfigs.baseUrl + 'login';
    }
		this.pageTitle.setTitle('Dashboard | Medicloude');
	}
